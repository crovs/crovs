...
- [H4XORNews App](link): The "H4X0R News" app is a project I built to learn and practice key iS development concepts using SwiftUI. Through this app, I explored list management, networking, the Observer design pattern, and integrating UIKit components with SwiftUI. It served as a hands-on way to deepen my understanding of these essential tools and techniques, helping me grow as an i0S developer.[![Static Badge](https://img.shields.io/badge/-Learn%20More-emeraldgreen?style=flat-square)](link)
